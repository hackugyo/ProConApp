...
public class IOUtils {
    ...
    public final static Charset Charsets_UTF_8 = Charset.forName("UTF-8");
    ...
    public static void writeToFile(String data, File file) throws IOException {
        writeToFile(data.getBytes(Charsets_UTF_8), file);
    }
    ...
    public static void writeToStream(String content, OutputStream os) throws IOException {
        ...
        try {
            writer = new BufferedWriter(new OutputStreamWriter(os, Charsets_UTF_8));
    ...
    public static String readAsString(InputStream is) throws IOException {
        ...
        try {
            String line;
            reader = new BufferedReader(new InputStreamReader(is, Charsets_UTF_8));
